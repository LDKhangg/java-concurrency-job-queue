...
- `JobProcessingService`: bounded queue tao backpressure cho producer, `RejectPolicy` `BLOCK`/`FAIL_FAST`, graceful shutdown drain pending job.
...
- Backlog tiep theo: `docs/roadmap.md` (scheduling/priority, virtual threads, observability, persistence, distributed).
